  ...
  <body class="transparent-header gradient-background-header front-page full-page">
    ...
    <div class="page-wrapper">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                      <div class="navbar-brand clearfix hidden-lg-up">
                        ...
                        <div id="logo-mobile" class="logo">
                          <a href="/"><img id="logo-img-mobile" src="images/logo_gold.png" alt="Sculpture Garden"></a>
                        </div>
                      ...
                      <div class="collapse navbar-collapse scrollspy" id="navbar-collapse-1">
                        ...
                        <ul id="fullpage-menu" class="navbar-nav ml-lg-auto">
                          <li data-menuanchor="firstPage" class="nav-item"><a href="#firstPage" class="nav-link smooth-scroll active">About</a></li>
                          <li data-menuanchor="secondPage" class="nav-item"><a class="nav-link smooth-scroll" href="#secondPage">Exhibits</a></li>
                          <li data-menuanchor="thirdPage" class="nav-item"><a class="nav-link smooth-scroll" href="#thirdPage">Documentary</a></li>
                          <li data-menuanchor="fourthPage" class="nav-item"><a class="nav-link smooth-scroll" href="#fourthPage">Location</a></li>
                          <li data-menuanchor="fifthPage" class="nav-item"><a class="nav-link smooth-scroll" href="#fifthPage">BREEF</a></li>
                        </ul>
                        <!-- main-menu end -->
                      </div>
                    </nav>
      ...
      <div class="fullpage-site-with-menu">
        ...
        <!-- section start -->
        <!-- ================ -->
        <section id="section-1" class="section dark-translucent-bg" style="background-image: url(http://res.cloudinary.com/breef/image/upload/c_scale,w_1600/v1511446752/garden/Atlas-1.jpg);">
          <div class="container">
            <div class="row justify-content-lg-center">
              <div class="col-lg-8">
                <div class="text-center">
                  <h1 class="title large object-non-visible" data-animation-effect="zoomIn" data-effect-delay="300">Sir Nicholas Nuttall Coral Reef Sculpture Garden</h1>
                  <div class="separator with-icon"><i class="fa fa-glass bordered" aria-hidden="true"></i></div>
                  <p class="object-non-visible" data-animation-effect="fadeInDown" data-effect-delay="200">The Bahamas Reef Environment Education Foundation (BREEF) has created the country’s first underwater living art gallery, deployed in October 2014.</p>
        ...
        <!-- section start -->
        <!-- ================ -->
        <section id="section-2" class="section dark-translucent-bg" style="background-image: url(images/restaurant-2-about.jpg);">
          <div class="container">
            <div class="row justify-content-lg-center">
        ...
        <!-- section start -->
        <!-- ================ -->
        <section id="section-3" class="section dark-translucent-bg" style="background-image: url(images/restaurant-2-menu.jpg);">
          <div class="container">
            <div class="row justify-content-lg-center">
                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-1.jpg" alt="" class="rounded-circle">
                      </div>
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-2.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-3.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-4.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
              ...
              <div class="tab-pane" id="pill-2">
                <div class="row">
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-5.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-6.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-7.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                        <h4 class="title">Aliquam atque ipsam nihil</h4>
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-8.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
              ...
              <div class="tab-pane" id="pill-3">
                <div class="row">
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-9.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                        <h4 class="title">Explicabo sed sequi recusandae</h4>
                        <p class="small mb-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihil, adipisci rem minus.</p>
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-10.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                        <h4 class="title">Aliquam atque ipsam nihil</h4>
                        <p class="small mb-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihil, adipisci rem minus.</p>
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-11.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                        <h4 class="title">Nihil adipisci rem minus</h4>
                        <p class="small mb-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihil, adipisci rem minus.</p>
                  ...
                  <div class="col-lg-3">
                    <div class="image-box text-center style-2 mb-20">
                      <div class="ph-40">
                        <img src="images/restaurant-dish-12.jpg" alt="" class="rounded-circle">
                      </div>
                      <div class="body padding-horizontal-clear">
                        <h4 class="title">Adipisicing elit aliquam atque</h4>
                        <p class="small mb-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam atque ipsam nihil, adipisci rem minus.</p>
        ...
        <section id="section-4" class="section dark-translucent-bg" style="background-image: url(images/restaurant-2-clients.jpg);">
        ...
        <!-- section start -->
        <!-- ================ -->
        <section id="section-5" class="section dark-translucent-bg" style="background-image: url(images/restaurant-2-contact.jpg);">
          <div class="container">
            <div class="row justify-content-lg-center">
              <div class="col-lg-8 text-center pv-20">
                ...
                <ul class="list-inline mb-20 text-center">
                  ...
                  <li class="list-inline-item"><a href="tel: 00 1234567890" class="link-dark"><i class="text-default fa fa-phone pl-10 pr-1"></i>+00 1234567890</a></li>
      ...
      <div class="subfooter">
        <div class="container">
          <div class="subfooter-inner">
            <div class="row">
              <div class="col-md-12">
                <p class="text-center">Copyright © 2017 <a target="_blank" href="https://breef.org">BREEF</a> &amp; <a target="_blank" href="https://www.bahamas.com">Bahamas Ministry of Tourism</a>. All Rights Reserved.
                  Built by <a href="mailto:acamerondev@protonmail.com">AC</a> at <a target="_blank" href="https://cstraight.com">CStraight Media</a>.
                </p>
              </div>
            </div>
          </div>
