  ...
  <div class="container">
    <div class="row justify-content-lg-center">
      <div class="col-lg-8 text-center">
        <h2 class="title text-center">Underwater Art Exhibits</h2>
        <div class="separator with-icon"><i class="fa fa-edit bordered"></i></div>
      </div>
    </div>
    <!-- Nav tabs -->
      ...
      <div class="col-lg-3">
        <div class="image-box text-center style-2 mb-20">
          ...
          <div class="body padding-horizontal-clear">
            ...
            <p class="small mb-10">The centrepiece sculpture “Ocean Atlas” is the largest underwater sculpture in the world.</p>
            <p class="lead text-default">Jason de Caires Taylor</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        <div class="image-box text-center style-2 mb-20">
          ...
          <div class="body padding-horizontal-clear">
            ...
            <p class="small mb-10">Giving attention to the role of the more insightful, wiser, older generation while paying homage to the role of Atlas.</p>
            <p class="lead text-default">Willicey Tynes</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        <div class="image-box text-center style-2 mb-20">
          ...
          <div class="body padding-horizontal-clear">
            ...
            <p class="small mb-10">Measures up to seven feet and honours the archipelago’s first known inhabitants, the Lucayans.</p>
            <p class="lead text-default">Andret John</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
